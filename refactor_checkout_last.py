...
success_block = get_lines(285, 305)
summary_block = get_lines(708, 759)
...
lines[708-1:759] = ['                <OrderSummary items={items} subtotal={subtotal} shipping={shipping} total={total} />\n']
