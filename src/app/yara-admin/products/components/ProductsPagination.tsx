...
export function ProductsPagination({
  rowsPerPage, setRowsPerPage, setCurrentPage, currentPage, totalPages, handlePageChange, totalItems, selectedCount
}: any) {
  return (
    <>
        <div className="p-4 border-t border-burgundy/5 bg-ivory/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {selectedCount > 0 && (
              <span className="text-sm font-medium text-burgundy bg-rose-gold/20 px-2 py-1 rounded-md">
