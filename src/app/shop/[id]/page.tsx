      ...
      <div className="pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            >
              ...
              <div className="flex gap-3 overflow-x-auto p-1.5 snap-x snap-mandatory no-scrollbar">
                {product.images.map((img, i) => (
                  ...
                  >
                    <Image src={img} alt="" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover" unoptimized />
                  </button>
                ))}
              </div>
            </motion.div>
            ...
            >
              <ProductInfo product={product} selectedColor={selectedColor} setSelectedColor={setSelectedColor} quantity={quantity} setQuantity={setQuantity} handleAddToCart={handleAddToCart} isAdding={isAdding} toggleItem={toggleItem} wishlisted={wishlisted} setIsSizeGuideOpen={setIsSizeGuideOpen} />
