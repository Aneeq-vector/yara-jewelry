                ...
                >
                  <div className="relative rounded-3xl overflow-hidden bg-champagne/30 mb-4">
                    <Link href={`/shop/${product.id}`} className="block relative aspect-square">
                      ...
                      loader={isPocketBaseResizable(product.images[0]) ? pbLoader : undefined} alt={product.name} fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
                    </Link>
